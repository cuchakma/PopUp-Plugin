...
class PopupMetaboxes{
    ...
    public function render_metabox_1() {
        ...
        $popup_autohide = $datas['popup_autohide'] === '1' ? 'checked' : '';
        $popup_unhide   = $datas['popup_unhide'] === '1'  ? 'checked' : '';
        ...
        <div class="metabox-main">
            ...
            <div class="metabox-5">
                ...
                <select name="popup_size" id="popup_size">
                    ...
                    <option value="landscape"<?php echo $popup_size == 'landscape'? 'selected' : '';?>>Landscape</option>
                    <option value="square" <?php echo $popup_size == 'square'? 'selected' : '';?>>Square</option>
                </select>
            </div>
        </div>
        <?php
    ...
    public function save_popup_data( $post_id ){
        ...
        $all_values = json_encode(array( 'popup_time' => $popup_time, 'popup_url' => $popup_url, 'popup_autohide' => $popup_autohide, 'popup_unhide' => $popup_unhide, 'popup_size' => $popup_size));
